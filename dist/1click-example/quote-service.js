...
exports.quoteBtcForEureOutput = quoteBtcForEureOutput;
exports.quoteEureForBtcOutput = quoteEureForBtcOutput;
...
function initSdk(jwt) {
    ...
    one_click_sdk_typescript_1.OpenAPI.TOKEN = jwt; // keep server-side in production if possible
}
async function quoteBtcForEureOutput(input) {
...
async function quoteEureForBtcOutput(input) {
