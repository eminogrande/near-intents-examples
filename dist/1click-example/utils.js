...
exports.groupTokensByBlockchain = groupTokensByBlockchain;
exports.displayTokensByBlockchain = displayTokensByBlockchain;
exports.displaySwapCostTable = displaySwapCostTable;
// Groups tokens by blockchain
function groupTokensByBlockchain(tokens) {
...
function displayTokensByBlockchain(tokens) {
    ...
    sortedBlockchains.forEach((blockchain) => {
        ...
        const sortedTokens = tokensByBlockchain[blockchain].sort((a, b) => a.symbol.localeCompare(b.symbol));
        console.log(`\n━━━ Chain: ${blockchain.toUpperCase()} ━━━`);
        console.table(sortedTokens.map((token) => ({
            Symbol: token.symbol,
...
function displaySwapCostTable(quote) {
